...
{
    public class ConcurrentDitionaryLazyCsvRepository : ICSVRepository
    {
        private readonly string directory;
        private ConcurrentDictionary<string, Lazy<List<string[]>>> csvFiles;

        public ConcurrentDitionaryLazyCsvRepository(string directory)
        {
            this.directory = directory;
            csvFiles = new ConcurrentDictionary<string, Lazy<List<string[]>>>(2, 1);
